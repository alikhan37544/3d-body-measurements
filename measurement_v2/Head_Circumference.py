...
def visualize_slice_with_circumference(mesh, slice_height):
    ...
    print(f"Head Circumference: {circumference:.2f} meters")
    ...
    plt.title(f"Slice at Height for Head Circumference: {slice_height:.2f} meters")
    plt.show()
...
if __name__ == "__main__":
    ...
    # Estimating head slice height
    # Adjust this based on the model; you might need to manually find a good value
    head_base_height = mesh.bounds[1][1] * 0.9  # Starting estimate
    visualize_slice_with_circumference(mesh, head_base_height)
