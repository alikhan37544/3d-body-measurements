...
def visualize_slice_with_circumference(mesh, slice_height):
    ...
    print(f"Waist Circumference: {circumference:.2f} meters")
    ...
    plt.title(f"Slice at Height for Waist Circumference: {slice_height:.2f} meters")
    plt.show()
...
if __name__ == "__main__":
    ...
    # Estimating waist slice height
    # This is a starting point and will likely need adjustment based on the specific model
    waist_height = mesh.bounds[0][1] + (mesh.bounds[1][1] - mesh.bounds[0][1]) * 0.5  # Adjust as necessary
    visualize_slice_with_circumference(mesh, waist_height)
